...
- `images/benchmark_gt_comparisons/panels/`: individual panels for each benchmark example, including ground truth, synthetic LR, bicubic input, SRCNN outputs, and SwinIR output.
